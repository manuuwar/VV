...
public class Alien extends Sprite {
    ...
    /**
     * Inicializa un nuevo alien y le asigna la imagen correspondiente en la
     * interfaz
     * 
     * @param x coordenada X de la posición del nuevo alien
     * @param y coordenada Y de la posición del nuevo alien
     *          Si alguna de las coordenadas indicadas supera los márgenes de la
     *          pantalla, se ubicará en el máximo permitido.
     *          Por ejemplo, si la coordenada X indicada supera el margen de la
     *          pantalla, se asignará a X el valor máximo posible, es decir, el
     ...
     * 
     * @param direction posición hacia la izquierda o derecha hacia la que se mueve
     *                  el alien
     */
    ...
    public class Bomb extends Sprite {
        ...
        /**
         * Inicializa el nuevo objeto bomba y le asigna las coordenadas indicadas y la
         * imagen correspondiente en la interfaz
         * 
         * @param x coordenada X de la posición de la nueva bomba
         * @param y coordenada Y de la posición de la nueva bomba
         *          Si el valor X o Y indicados superan el margen de la pantalla, se les
         *          asignará el valor máximo permitido.
